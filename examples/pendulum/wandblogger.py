...
from examples.pendulum.plot import PlotPendulum, PlotPendulumPlotly
import wandb
import os.path
...
class PendulumWandbLogger(WandbLogger):
    ...
    def log(self, model, trajectory, x, y, data, rewardMax, loss_aq, backup_triggered, episode, info):
        self.datalogger.log(model, trajectory, x, y, data, rewardMax, loss_aq, backup_triggered, episode, info)
        content = {}
        ...
        super().log(model, trajectory, x, y, data, rewardMax, loss_aq, backup_triggered, episode, content)
